...
export class HomeTitleComponent {
  ...
  onScroll(event: Event) {
    getParalaxScroll(event)((offset) => {
      ...
      applyCustomParalax(document.getElementById('sunsetBackground'), 'background', 2, getBackgroundGradient, offset)
      ...
      applyCustomParalax(document.getElementById('water'), 'background', 1, getWaterGradient, offset)
    })
  }
}
